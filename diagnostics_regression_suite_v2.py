...
CASES = [
    ...
    {
        "name": "single_leg_profit_v2",
        "command": [sys.executable, "diagnostics_single_leg_profit_v2.py"],
    },
    {
        "name": "hybrid_focus_policy_v1",
        "command": [sys.executable, "diagnostics_hybrid_focus_policy_v1.py"],
    },
]
...
def main() -> int:
    print("[TEST] Starting diagnostics regression suite v2...")
    ...
    if any(not r.ok for r in results):
        print("[RESULT] Regression suite v2 finished with failures")
        return 1

    print("[RESULT] Regression suite v2 finished successfully")
    return 0
