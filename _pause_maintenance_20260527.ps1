# _pause_maintenance_20260527.ps1
#
# Pausa automatica do runner durante manutencao Polymarket
# Data: 2026-05-27  Janela: 12:10-12:20 UTC (09:10-09:20 local UTC-3)
#
# Uso (ja rodando em background via Start-Process):
#   Start-Process powershell -ArgumentList "-File _pause_maintenance_20260527.ps1" -WorkingDirectory $PWD
#
# O script:
...
$logFile = "$repo\logs\_maintenance_20260527.log"
...
$stopAt    = [datetime]"2026-05-27 09:05:00"   # para 5 min antes
$restartAt = [datetime]"2026-05-27 09:25:00"   # reinicia 5 min apos fim previsto

Log "=== MANUTENCAO POLYMARKET 2026-05-27 ==="
