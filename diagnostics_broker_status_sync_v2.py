...
def main():
    ...
    print("[TEST] Starting broker status sync diagnostic v2...")
    ...
    print("\n=== APPLY BROKER STATUS SYNC V3 (partial/full) ===")
    ...
    print("\n=== APPLY BROKER STATUS SYNC V3 (cancel remaining -> terminal reconcile) ===")
    sync_logs_2, reconcile_2 = sync_executor_from_broker_open_orders_v3(executor, broker_open_orders_2)
