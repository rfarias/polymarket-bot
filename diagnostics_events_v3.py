from market.events_discovery_v3 import (
    fetch_active_events,
    extract_relevant_btc_markets_from_events,
    print_debug_event_samples,
)

print("[TEST] Starting event-based diagnostics v3...")
...
print_debug_event_samples(all_events, limit=25)
...
print("\n[TEST] Event-based diagnostics v3 finished 🚀")
