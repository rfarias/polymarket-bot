...
def monitor_live_minimal_guarded_v2(duration_seconds: int | None = None) -> None:
    ...
    if not cfg.shadow_only and cfg.real_posts_enabled:
        print("[GUARD] Real posting is intentionally blocked in v2 until live fill reconciliation + real flatten are implemented.")
        return
    ...
    while time.time() - started_at < run_for:
        ...
        if time.time() >= next_print:
            ...
            print("\n===== LIVE MINIMAL GUARDED V2 SNAPSHOT =====")
