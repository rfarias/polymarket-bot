...
from market.queue_5m_v4 import build_5m_queue_v4, UNFILLED_EXIT_TRIGGER_SECS_TO_END_ON_NEXT_1
...
async def monitor_setup1_shadow_real_v3(duration_seconds: int = 60) -> None:
        ...
        try:
            while time.time() - started_at < duration_seconds:
                ...
                if time.time() - last_print >= 2:
                    ...
                    print("\n===== SETUP1 SHADOW REAL SNAPSHOT V3 =====")
                    for slot_name in ("current", "next_1", "next_2"):
                        item = slot_bundle["queue"].get(slot_name)
