...
from market.dryrun_lifecycle_v2 import advance_public_dryrun_lifecycle_v2


def monitor_setup1_shadow_public_rest_v7(duration_seconds: int = 60) -> None:
    broker = DryRunBroker()
    ...
    while time.time() - started_at < duration_seconds:
        ...
        if time.time() >= next_print:
            ...
            print("\n===== SETUP1 SHADOW PUBLIC REST SNAPSHOT V7 =====")
            ...
            lifecycle_logs = advance_public_dryrun_lifecycle_v2(executor, broker, slot_state)
