...
class PolymarketBrokerV2(BrokerInterface):
    def __init__(
        self,
        *,
    ...
    @classmethod
    def from_env(cls) -> "PolymarketBrokerV2":
        load_dotenv()
        return cls(
    ...
    def healthcheck(self) -> BrokerHealth:
        try:
            ...
            return BrokerHealth(ok=bool(ok), mode=self.mode, host=self.host, message="PolymarketBrokerV2 ready", server_time=server_time)
