from market.queue_5m import build_5m_queue, UNFILLED_EXIT_TRIGGER_SECS_TO_END_ON_NEXT_1

print("[TEST] Starting 5m queue diagnostics...")
...
print("\n[TEST] 5m queue diagnostics finished 🚀")
