from market.slug_discovery_v2 import fetch_operational_fast_events, split_current_and_next

print("[TEST] Starting operational diagnostics...")
...
print("\n[RESULT] Current and next by timeframe:")
...
print("\n[TEST] Operational diagnostics finished 🚀")
